...
Above is the map created as the final project for my first year GIS courses (GGRA30). The map shows the location, ticket price, national level, and description in attachment of famous tourist attractions in Nanjing, the capital city of Jiangsu province.<!-- readmore -->
